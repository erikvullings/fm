...
- 2026-08-19 claude: Diagnosed from source only (no Windows machine available in this session) —
  see Context for the full path-mismatch chain. Confirmed via CI logs
  (`gh api repos/erikvullings/fm/actions/jobs/96200645821/logs`, run 32293884533) that both
