      ...
      return m(ModalPanel, {
        ...
        description: m('div', [
          m('input.fm-shortcuts-help-search', {
            type: 'text',
            placeholder: 'Filter by name, description, or shortcut…',
          ...
          m('.fm-shortcuts-help-capture', [
            m(
              ...
              'Press a key combination to look it up:',
            ),
            m('input#fm-shortcuts-help-capture-input.fm-shortcuts-help-capture-input', {
              type: 'text',
              readonly: true,
              placeholder: 'Click here, then press a shortcut…',
            ...
            capturedShortcut === undefined
              ...
              : m(
                  ...
                  captureMatches.length === 0
                    ? `No action is bound to ${capturedShortcut}.`
                    : captureMatches
