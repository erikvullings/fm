...
const OWNING_TASK = '0012';

/**
 * HTTP transport adapter, wrapping the Orval-generated client behind
 * `FileManagerClient` (spec §12). Every method is completed by task
...
export class HttpFileManagerClient implements FileManagerClient {
  private notImplemented(methodName: string): never {
    throw new NotImplementedError(`HttpFileManagerClient.${methodName}`, OWNING_TASK);
  }
