...
use fm_transport_dto::{
    ...
    RuntimeCapabilitiesDto, RuntimeKindDto, SearchInFileRequestDto, SearchInFileResponseDto,
    SetPaneActivityRequest, SettingsDto, StartChecksumRequestDto, StartChecksumResponseDto,
